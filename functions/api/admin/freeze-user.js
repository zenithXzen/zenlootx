...
export async function onRequestPost({ request, env }) {
  try {
    ...
    await logAdminAction(env, admin.id, isFreezing ? 'freeze_user' : 'unfreeze_user', userId, 'user', { duration: duration || null, deductAmount: deductAmount ? Number(deductAmount) : null });
